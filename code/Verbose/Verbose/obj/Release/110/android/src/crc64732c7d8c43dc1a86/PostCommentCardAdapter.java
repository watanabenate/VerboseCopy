...
public class PostCommentCardAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Verbose.src.adapters.PostCommentCardAdapter, Verbose", PostCommentCardAdapter.class, __md_methods);
	}


	public PostCommentCardAdapter ()
	{
		super ();
		if (getClass () == PostCommentCardAdapter.class)
			mono.android.TypeManager.Activate ("Verbose.src.adapters.PostCommentCardAdapter, Verbose", "", this, new java.lang.Object[] {  });
	}
