...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Verbose.src.adapters.PostCardAdapter, Verbose", PostCardAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == PostCardAdapter.class)
			mono.android.TypeManager.Activate ("Verbose.src.adapters.PostCardAdapter, Verbose", "", this, new java.lang.Object[] {  });
	}
