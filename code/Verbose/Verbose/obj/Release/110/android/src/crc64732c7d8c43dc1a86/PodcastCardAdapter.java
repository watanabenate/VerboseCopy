...
public class PodcastCardAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Verbose.src.adapters.PodcastCardAdapter, Verbose", PodcastCardAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == PodcastCardAdapter.class)
			mono.android.TypeManager.Activate ("Verbose.src.adapters.PodcastCardAdapter, Verbose", "", this, new java.lang.Object[] {  });
	}
