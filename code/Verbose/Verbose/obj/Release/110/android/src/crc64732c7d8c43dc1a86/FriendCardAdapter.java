...
public class FriendCardAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Verbose.src.adapters.FriendCardAdapter, Verbose", FriendCardAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == FriendCardAdapter.class)
			mono.android.TypeManager.Activate ("Verbose.src.adapters.FriendCardAdapter, Verbose", "", this, new java.lang.Object[] {  });
	}

	public FriendCardAdapter (boolean p0)
	{
		super ();
		if (getClass () == FriendCardAdapter.class)
			mono.android.TypeManager.Activate ("Verbose.src.adapters.FriendCardAdapter, Verbose", "System.Boolean, mscorlib", this, new java.lang.Object[] { p0 });
	}
