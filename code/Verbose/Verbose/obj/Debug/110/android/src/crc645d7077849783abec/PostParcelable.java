...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Verbose.Data.PostParcelable, Verbose.Data", PostParcelable.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == PostParcelable.class)
			mono.android.TypeManager.Activate ("Verbose.Data.PostParcelable, Verbose.Data", "", this, new java.lang.Object[] {  });
	}

	public PostParcelable (android.os.Parcel p0)
	{
		super ();
		if (getClass () == PostParcelable.class)
			mono.android.TypeManager.Activate ("Verbose.Data.PostParcelable, Verbose.Data", "Android.OS.Parcel, Mono.Android", this, new java.lang.Object[] { p0 });
	}
